...
public class MathUtilityAdvancedTest {
    ...
    //2 -> 2
    //6 -> 720
    // mang 2 chiều, cột 0 là n, cột 1 là expected
    // n      expected
...
//BẮT NGOẠI LÀ THÌ SAO, TỨC LÀ HÀM CỦA TA GETF() TRẢ VỀ NGOẠI LỆ
...
//      nên viết code chính đan xen, xen kẽ cùng với việc thiết kế các test case
//      để test code chính
//      lập trình mà viết code chính và code test (JUnit, Unit Test(
//      đan xen xen kẽ nhau thì gọi là TDD
//      VIẾT CODE HHUONGWS THEO VIỆC KIỂM THỬ NGAY CODE

// DDT: Data Driven Testing: là kĩ thuật mở rộng bổ sung thêm cho TDD
//     trong đó việc viết code test đc tách riêng ra so với test data
//     nghĩa là bộ dữ liệu test thường đc đặt để ở 1 mảng 2 chiều
//     hoặc để ở table, file txt, Excel sau đó đc nhồi/fill/map vào trong 
//     câu lệnh kiểm thử!!!
//     Việc data tách riêng ra sau đó fill trở lại hàm so sánh qua tên biến
//     THÌ DDT ĐC GỌI LÀ PARAMETTERIZED TESTING 